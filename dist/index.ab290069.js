...
})({"hhQyU":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "b217b886ab290069";
...
},{}],"f14uM":[function(require,module,exports) {
var _deleteTaskJs = require("./deleteTask.js");
async function getTasks() {
    const tasks = await fetch("/.netlify/functions/tasks").then((response)=>response.json());
    console.log(tasks);
    ...
    tasks.forEach((item)=>{
        ...
        deleteBtn.onclick = function(e) {
            ...
            (0, _deleteTaskJs.deleteTask)(e.currentTarget.getAttribute("id"));
        };
        // Update Task
...
},{"./deleteTask.js":"1pHRk"}],"1pHRk":[function(require,module,exports) {
...
},{}]},["hhQyU","f14uM"], "f14uM", "parcelRequire5b66")

//# sourceMappingURL=index.ab290069.js.map
